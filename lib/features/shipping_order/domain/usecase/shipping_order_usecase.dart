...
class ShippingOrderUseCaseImpl extends ShippingOrderUseCase{
  ...
  @override
  Future<Either<Failure, List<ShippingOrderEntity>>> getOrderListByStatus(OrderType type, OrderStatus status) async{
      return await _shippingOrderRepository.getOrderListByStatus(type, status);
  }
}